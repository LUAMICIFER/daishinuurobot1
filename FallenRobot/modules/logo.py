...
async def lego(event):
    ...
    try:
        ...
        await telethn.send_file(
            event.chat_id, file=fname, caption=f"ʟᴏɢᴏ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Daishinyuu ✘ ʀᴏʙᴏᴛ"
        )
        await pesan.delete()
...
__help__ = """
Daishinyuu Robot can create some beautiful and attractive logo for your profile pics.
